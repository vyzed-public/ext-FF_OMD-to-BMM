...
#### Prior art: (in project: [ext-FF_BMM-to-OMD-paste](https://github.com/vyzed-public/ext-FF_BMM-to-OMD-paste)) — issue: [Package as a permanent Private Extension through AMO](https://github.com/vyzed-public/ext-FF_BMM-to-OMD-paste/issues/2)
